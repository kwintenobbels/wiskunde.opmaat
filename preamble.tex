...
\definecolor{xmdarkblue}{rgb}{0.122, 0.671, 0.835}  
\definecolor{xmblue}{rgb}{0.114, 0.553, 0.69}       
\definecolor{xmgreen}{rgb}{0.13, 0.55, 0.13}        

\definecolor{xmaccent}{rgb}{0.867, 0.541, 0.18}     
...
\pdfOnly{
  \renewcommand{\important}[1]{\ensuremath{\colorbox{xmaccent!50!white}{$#1$}}}
  \renewcommand{\importantcell}[1]{\ensuremath{\cellcolor{xmaccent!40!white}#1}}   
}
...
% De optionele korte abstract kan worden gebruikt voor pseudo-grappige abstracts, dus dus globaal al dan niet kunnen worden gebruikt...
% Globale settings:
