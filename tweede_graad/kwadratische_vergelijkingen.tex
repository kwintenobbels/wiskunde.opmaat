...
%  Een lijn commentaar staat achter een %-teken. 

% In een opmerking wordt aan de leerling duidelijk gemaakt welke procedure ingeoefend zal worden. 
% \begin{leerdoelstellingen}
...
%     \begin{expandable} A very gentle introduction to complex numbers.
