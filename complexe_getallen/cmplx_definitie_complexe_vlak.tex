...
\begin{oplossing}
	...
	\addplot [red, mark = *] coordinates {( -3,-4)} {};
	\addplot [red, mark = *] coordinates {( 2, 5)} {};

	\node [above right, red] at (axis cs:  3, 3) {$3+3i$};
	\node [below left , red] at (axis cs: -4,-4) {$-4-4i$};
	\node [right      , red] at (axis cs:  0,-2) {$-2i$};
	\node [below right, red] at (axis cs:  4, 0) {$4$};
	\node [below left , red] at (axis cs: -3,-4) {$-3-4i$};
	\node [above right, red] at (axis cs:  2, 5) {$2+5i$};
