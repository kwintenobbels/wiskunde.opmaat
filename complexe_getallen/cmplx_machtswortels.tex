...
Laat $w = r(\cos\theta + i\sin\theta) \in \mathbb{C}\setminus\{0\}$ en $n \in \mathbb{N}\setminus\{0\}$.
We zoeken alle oplossingen $z$ van de vergelijking $z^n = w$.
...
$$
\rho^n \left( \cos(n\varphi) + i\sin(n\varphi) \right)
