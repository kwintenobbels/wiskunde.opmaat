...
\hypertarget{oef1.9}{Bepaal} telkens de waarde(n) van de reële parameters waarvoor de veeltermen $A(x)$ en $B(x)$ gelijk zijn.
	...
	\begin{question} \( A(x) = (ax+7)x$      en $B(x) = 7x-3x^2    \) zijn gelijk voor \( a = \answer[onlineshowanswerbutton]{-3} \) \end{question} %waarbij $a \in \R$
	\begin{question} \( A(x) = (ax+b)(3x-2)$ en $B(x) = 3x^2+6-11x \) zijn gelijk voor \( a = \answer[onlineshowanswerbutton]{1} \) en \( b = \answer[onlineshowanswerbutton]{-3} \) \end{question} %waarbij $a,b \in \R$
