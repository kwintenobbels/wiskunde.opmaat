...
Bepaal telkens de exacte waarde(n) van de parameters zodat \(A(x)\) deelbaar is door \(B(x)\). 
	...
	\begin{question} \( A(x) = ax^3 + 19x^2 + bx + 8        \quad \text{ en } \quad B(x) = (x-2)(x+4) \) \begin{uitkomst} \( a = 10\) en \(b = -82                           \) \end{uitkomst} \end{question} 
	\begin{question} \( A(x) = x^4 + ax^3 - 9x^2 + 18x + b  \quad \text{ en } \quad B(x) = x(x-2)     \) \begin{uitkomst} \( a = -2\) en \(b = 0                             \) \end{uitkomst} \end{question} 
	\begin{question} \( A(x) = -2x^3 + bx - 2ax^2 + 3a      \quad \text{ en } \quad B(x) = x+a        \) \begin{uitkomst} \( a = 0\)  of \(b = 3                             \) \end{uitkomst} \end{question} 
