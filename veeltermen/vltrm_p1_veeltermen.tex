...
\begin{definition} De nulwaarde van een veelterm. 
    ...
    Is de getalwaarde van een veelterm in een reëel getal $r$ gelijk aan nul, dan is $r$ een \textbf{nulwaarde} van die veelterm. De uitspraak {\em $r$ is een nulwaarde van $A(x)$} is dus gelijkwaardig met de uitspraak {\em $A(r) = 0$}. Met behulp van het symbool $\Leftrightarrow$ voor equivalentie wordt dit in symbolen:
    \[
