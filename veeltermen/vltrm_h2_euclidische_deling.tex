...
\begin{example}[Delen-met-rest voor natuurlijke getallen.]\nl
...
%       Als de rest gelijk is aan \(0\), dan zeggen we  dat  \(d\) een \textit{deler} is van \(D\), en we noteren \(d|D\). Merk op dat in dat geval ook het quotiënt \(q\) een deler is van \(D\) (dus ook \(q|D\)), en dat we \(D\) dus kunnen schrijven als een product
%       \[
%       D=q\cdot d
%       \]
%       Dus, \(5\) en \(7\) zijn allebei delers van \(35\) want \(35=5\cdot7\).
\end{example}
...
\begin{example}[Voorbeelden deling van veeltermen]\nl
     
    % layout kan beter? tabel met enkel de veeltermen, en D/d/Q/R in de header ?
    \begin{tabular}{lcll}
