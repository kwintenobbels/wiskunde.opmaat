...
%& = (x-2) \cdot \left({\red{3}}x^2 + {\graf{11}}x + {\blue{30}}\right) + {\gray{73}}.
\end{align*}
...
\begin{array}{c|HHHH}
	& 3 & 5 & 8 & 13 \\[0.2cm]
2 & \downarrow  & 2 \cdot {\red{3}}  & 2 \cdot {\graf{11}}  & 2 \cdot {\blue{30}}  \\[0.2cm]
\hline 
\vrule height 1.2em width 0pt 
	& {\red{3}} & {\graf{11}} & {\blue{30}} & \multicolumn{1}{|c}{{\gray{73}}} 
\end{array}
\)
}
\end{algorithm} 
