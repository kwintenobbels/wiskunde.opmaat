...
\begin{example} 
	...
	\renewcommand{\bullet}{}   % Willen we bullets hier? Deze hack werkt niet in html ...
	\[
	%\hspace{-7.6cm} ????
	...
	\bullet&p(x)&\textrm{ is deelbaar door }   &(x+3)&\textrm{ omdat }&p&(&-3&)&=   &0\\
	%\bullet&(x-5)&\nmid&p(x)&\textrm{ omdat }&p&(& 5&)&\neq&0\\
	\bullet&p(x)&\textrm{ is niet deelbaar door }&(x-9)&\textrm{ omdat }&p&(& 9&)&\neq&0\\
	\bullet&p(x)&\textrm{ is niet deelbaar door }&(x+9)&\textrm{ omdat }&p&(&-9&)&\neq&0.
	\end{array}
	\]
	 
	%We vinden hier 4 delers van de vorm \(x-a\). Een 4de-graadsveelterm kan maximaal 4 delers van de vorm \(x-a\) hebben. \((x-1)(x+1)(x-3)(x+3) = x^4-10x^2+9\), dus we hebben de veelterm \(x^4-10x^2+9\) volledig ontbonden in factoren.
\end{example}
...
\begin{example} 
	...
	%In dit speciale geval van een deler van de eerste graad is het \hyperref[xim:horner]{rekenschema van Horner} een alternatieve manier om het quotiënt te bepalen.
\end{example}
