...
\ifonlineTF{
	\renewcommand{\TJa }{\makebox[2.5cm]{Eenterm }}
	\renewcommand{\TNee}{\makebox[2.5cm]{Geen eenterm}}
}{
	\renewcommand{\TJa }{\makebox[0.75cm]{Ja }}
	\renewcommand{\TNee}{\makebox[0.75cm]{Nee}}
}
...
\begin{exercise} % oef 4
	\begin{statement} Bepaal telkens de graad, de hoogstegraadsco\"effici\"ent en de constante term. \end{statement}

	\begin{question} \( x^4-3x^2+2x-1             \)  \hfill\makebox[10cm][l]{\begin{uitkomst}[toonuitkomst] graad $4$, hoogstegraadscoëfficient $ 1 $         en constante term $-1$. \end{uitkomst}} \end{question}
	\begin{question} \( \sqrt{5}\,x^3-2x          \)  \hfill\makebox[10cm][l]{\begin{uitkomst}[toonuitkomst] graad $3$, hoogstegraadscoëfficient $\sqrt{5}   $ en constante term $ 0$. \end{uitkomst}} \end{question}
	\begin{question} \( \D x+\frac{1}{3}\,x^3+x^2 \)  \hfill\makebox[10cm][l]{\begin{uitkomst}[toonuitkomst] graad $3$, hoogstegraadscoëfficient $\frac{1}{3}$ en constante term $ 0$. \end{uitkomst}} \end{question}
	\begin{question} \( 5x+2                      \)  \hfill\makebox[10cm][l]{\begin{uitkomst}[toonuitkomst] graad $1$, hoogstegraadscoëfficient $ 5 $         en constante term $ 2$. \end{uitkomst}} \end{question}
	\begin{question} \( 2                         \)  \hfill\makebox[10cm][l]{\begin{uitkomst}[toonuitkomst] graad $0$, hoogstegraadscoëfficient $ 2 $         en constante term $ 2$. \end{uitkomst}} \end{question}
	\begin{question} \( (2x^3-7)^2                \)  \hfill\makebox[10cm][l]{\begin{uitkomst}[toonuitkomst] graad $4$, hoogstegraadscoëfficient $ 4 $         en constante term $49$. \end{uitkomst}} \end{question}
	\begin{question} \( (-5x+7)(3x^2-5x+8)        \)  \hfill\makebox[10cm][l]{\begin{uitkomst}[toonuitkomst] graad $3$, hoogstegraadscoëfficient $-15$         en constante term $56$. \end{uitkomst}} \end{question}
	\begin{question} \( (x-2)^5                   \)  \hfill\makebox[10cm][l]{\begin{uitkomst}[toonuitkomst] graad $5$, hoogstegraadscoëfficient $ 1 $         en constante term $32$. \end{uitkomst}} \end{question}
\end{exercise}
