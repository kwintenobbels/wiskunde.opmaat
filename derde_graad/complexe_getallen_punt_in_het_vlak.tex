...
\textbf{Vaardigheid:} Je tekent een gegeven complex getal in het complexe vlak en bepaalt de cartesische schrijfwijze voor gegeven punten. 
...
Als je punten in het vlak bekijken als coördinaten of koppels reële getatten, neem je een horizontale \(x\)-as en een verticale \(y\)-as. 
Als je punten in het vlak bekijken als complexe getallen, neem je een horizontale reële-as (met eenheid 1) en een verticale imaginaire-as (met eenheid \(i\)). 
...
\begin{image}[0.7\textwidth]
	\begin{tikzpicture}[scale=0.8]
		\begin{scope}
			...
			\end{axis}
			\node[below] at (3,0) {Het vlak met \textit{koppels re\"ele getallen} $(a,b)$.};
		\end{scope}
...
\begin{exercise}
	...
	\begin{question}
		...
		\begin{tikzpicture}[scale=1]
			...
			\draw[help lines, color=gray!50] (-5,-4) grid (3,2);
			...
			\filldraw[blue] (-2,-1) circle (2pt) node[below left] {\(z\)};
		\end{tikzpicture}
	...
	\begin{oplossing}
		...
		De algemene schrijfwijze van een complex getal wordt gegeven door \(z = a+bi = \Re{z}+ \Im{z}i\). Het reëel en imaginair deel lezen we af door te projecteren op de assen. Het complex getal is gelijk aan \(-2-i\).
		...
		\begin{tikzpicture}[scale=1]
			...
			% Mark the complex number z = -2 - i
			\filldraw[blue] (-2,-1) circle (2pt) node[below left] {\(z = -2 - i\)};
	...
	\begin{oplossing}
		\begin{image}
			\begin{tikzpicture}[scale=1]
				...
				\draw[->] (0,-2) -- (0,2.5) node[above] {$\Im$};
				
				% Mark tick marks on the axes (optional)
				...
				% 1 (which is 1 + 0i)
				\filldraw[red] (1,0) circle (2pt) node[below right] {\(1\)};
				
				% i (which is 0 + i)
				\filldraw[red] (0,1) circle (2pt) node[above left] {\(i\)};
				
				% -1 (which is -1 + 0i)
				\filldraw[red] (-1,0) circle (2pt) node[below left] {\(-1\)};
				
				% -i (which is 0 - i)
				\filldraw[red] (0,-1) circle (2pt) node[below right] {\(-i\)};
				
				% 0 (the origin)
				\filldraw[blue] (0,0) circle (2pt) node[below left] {\(0\)};
			\end{tikzpicture}
...
\begin{exercise} Schrijf volgende getallen in de vorm \(a+bi\).
...
\begin{question} \( z_{4} = \answer{-4i     } \) \end{question}
\begin{question} \( z_{5} = \answer{4 + 2i  } \) \end{question}
...
\begin{image}
	\begin{tikzpicture}[scale=0.8]
		...
		\draw[help lines, color=gray!30] (-5,5) grid (-5,5);
		...
		\filldraw[blue] (-2,1) circle (2pt) node[right] {\(z_1\)};
		\filldraw[blue] (0,0) circle (2pt) node[right] {\(z_2\)};
		\filldraw[blue] (-1,-3) circle (2pt) node[right] {\(z_3\)};
		\filldraw[blue] (0,-4) circle (2pt) node[right] {\(z_4\)};
		\filldraw[blue] (4,2) circle (2pt) node[right] {\(z_5\)};
