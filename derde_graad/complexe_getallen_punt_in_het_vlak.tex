...
Als je punten in het vlak bekijkt als coördinaten of koppels reële getallen, neem je een horizontale \(x\)-as en een verticale \(y\)-as. 
Als je punten in het vlak bekijkt als complexe getallen, neem je een horizontale reële-as (met eenheid 1) en een verticale imaginaire-as (met eenheid \(i\)). 
